...
public class PipeconfLoader {
    ...
    private DefaultPiPipeconf.Builder baseFpmPipeconf() throws FileNotFoundException {
        final URL p4InfoUrl = this.getClass().getResource("/fpm/main.p4info");
