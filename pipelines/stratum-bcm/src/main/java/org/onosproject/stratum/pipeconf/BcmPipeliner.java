...
public class BcmPipeliner extends AbstractHandlerBehaviour implements Pipeliner {
    ...
    protected List<Port> devicePorts;
    ...
    private Map<Integer, TrafficTreatment> cachedNextTreatments;
    ...
    public void init(DeviceId deviceId, PipelinerContext context) {
        ...
        devicePorts = deviceService.getPorts(deviceId);
        cachedNextTreatments = Maps.newHashMap();
        ...
        forwardingTranslator = new ForwardingObjectiveTranslator(deviceId, devicePorts, capabilities, bcmObjectiveStore);
    ...
    public void forward(ForwardingObjective obj) {
        try {
            ...
            if (obj.nextId() != null && bcmObjectiveStore.getStoredNextObjective(obj.nextId()) == null) {
    ...
    public void next(NextObjective obj) {
        ...
        Collection<ForwardingObjective> fwds = bcmObjectiveStore.getAssociatedFwdObjectives(obj.id());
